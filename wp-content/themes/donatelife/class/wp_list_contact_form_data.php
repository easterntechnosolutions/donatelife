<?php 
class Contact_Form_List extends WP_List_Table {
    ...
    function get_columns() {
        $columns = [
            ...
            'id'       => __('ID', 'donatelife'),
            'cdate'       => __('Date', 'donatelife'),
            'cname'       => __('Name', 'donatelife'),
            'cemail'     => __('Email', 'donatelife'),
            'ccontact'    => __('Phone', 'donatelife'),
            'csubject'     => __('Subject', 'donatelife'),
            'cmessage'     => __('Message', 'donatelife'),
