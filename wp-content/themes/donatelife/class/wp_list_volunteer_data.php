<?php 
class Volunteer_List extends WP_List_Table {
    ...
    public function process_bulk_action() {
        global $wpdb;
        $table_name = $wpdb->prefix . 'volunteer_master';
            ...
            jQuery(document).ready(function($) {
                $(".view-popup").on("click", function(e) {
                    ...
                    $.ajax({
                        ...
                        type: "POST",
                        data: {
                            action: "load_volunteer_data", // Custom action hook
                            id: id
                        },
