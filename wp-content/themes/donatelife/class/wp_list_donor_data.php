<?php 
class Donor_List extends WP_List_Table {
    ...
    function get_columns() {
        $columns = [
            ...
            'id'       => __('ID', 'donatelife'),
            'todaydate'       => __('Date', 'donatelife'),
            'dfirstname'     => __('First Name', 'donatelife'),
            'dgender'    => __('Gender', 'donatelife'),
            'ddist'     => __('City', 'donatelife'),
            'dcontact'     => __('Contact No', 'donatelife'),
    ...
    function get_sortable_columns() {
        $sortable_columns = [
            'id'   => ['id', true],
            'todaydate' => ['todaydate',true],
            'dfirstname' => ['dfirstname', false]
    ...
    public function process_bulk_action() {
        global $wpdb;
        $table_name = $wpdb->prefix . 'donor_master';
            ...
            jQuery(document).ready(function($) {
                $(".view-popup").on("click", function(e) {
                    ...
                    $.ajax({
                        ...
                        type: "POST",
                        data: {
                            action: "load_modal_content", // Custom action hook
                            id: id
                        },
