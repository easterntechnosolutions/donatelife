$(document).ready(function () {
  let e = document.getElementById("name"),
    ...
    // org
    $("#cyp1").on("click", function () {
      $(".croppie-container").remove(),
        $(".act").html(
          '<img  id="imagenFondo" style="height: 300px; width: 300px"   class="img-responsive d-none"  id="set"      />'
        ),
        $("#my-image1").removeAttr("disabled").click();
    }),
    //org end
        ...
        a.readAsDataURL(this.files[0]),
          (a.onload = function (a) {
            ...
            var l = new Croppie($("#imagenFondo")[0], {
              viewport: { width: 420, height: 420, type: "circle" },
              ...
              $("#use").on("click", function () {
                (n.innerHTML = e.value),
                  ...
                  l.result("base64").then(function (n) {
                    ...
                    // org
                    var bg = $('#bg_img').attr('src');
                    // end
                    $("#result").attr("src", i[0].image),
                      mergeImages([
                        { src: bg, x: 0, y: 0 },
                        { src: i[0].image, x: 85, y: 50 },
                      ]).then((n) => {
                        $("#bg_img").attr("src", n),
                          $("#bg_img").on("load", function () {
                            ...
                            (a.width = o[0].naturalWidth),
                              ...
                              (l.font =
                                "600  40px 'Myriad Set Pro', Arial, Helvetica, sans-serif"),
                            //   l.fillText(n, 280, 530),
                               l.fillText(n, 295, 505),
                              (l.textAlign = "center"),
                              (l.fillStyle = "white"),
                              (l.textBaseline = "middle"),
                              (l.font =
                                "600  24px 'camber', Arial, Helvetica, sans-serif"),
    ...
    $("#my-image1").change(function () {
      if (
        ($("#my-image1").attr("disabled", "true"),
        $("#cyp1").removeClass("d-none"),
        FileReader)
      ) {
        var a = new FileReader();
        a.readAsDataURL(this.files[0]),
          (a.onload = function (a) {
            $("#imagenFondo").attr("src", a.target.result);
            var l = new Croppie($("#imagenFondo")[0], {
              viewport: { width: 198, height: 198, type: "circle" },
              boundary: { width: 198, height: 198 },
              enableOrientation: !0,
            });
            $("#use").fadeIn(),
              $("#corp").removeClass("d-none"),
